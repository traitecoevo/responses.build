...
data_study <- extract_dataset(austraits, dataset_id, partial_matches_allowed = FALSE)
...
new_question <- function(txt) {
  x <- questions(responses.build:::notetaker_add_note, responses.build:::notetaker_as_note(txt)) %>%
